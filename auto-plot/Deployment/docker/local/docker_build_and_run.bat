...
echo.
call :info "Checking requirements file"
call :check_file "!REQUIREMENTS_PATH!"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

echo.
call :info "Checking resources directory"
call :check_file "!RESOURCES_DIR!"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

echo.
call :info "Checking app directory"
call :check_file "!APP_DIR!"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

echo.
call :info "Copying requirements"
call :copy "!REQUIREMENTS_PATH!" "!CWD!\requirements.txt"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

echo.
call :info "Copying resources directory"
call :copy_dir "!RESOURCES_DIR!" "!CWD!\Resources"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

echo.
call :info "Copying app directory"
call :copy_dir "!APP_DIR!" "!CWD!\App"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end
...
:cleanup
echo.
call :info "Cleaning copied requirements"
call :remove "!CWD!\requirements.txt"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

call :info "Cleaning copied resources directory"
call :remove_dir "!CWD!\Resources"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end

call :info "Cleaning copied app directory"
call :remove_dir "!CWD!\App"
if ERRORLEVEL 1 set SCRIPT_FAILED=1 & goto :end
