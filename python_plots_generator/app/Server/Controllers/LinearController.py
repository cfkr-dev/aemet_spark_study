...
from app.Server.DTOS.LinearDTO import LinearDTO

from app.Server.Models.LinearModel import LinearModel
from app.Plotters.LinearPlotter import LinearPlotter
