...
object Constants {
  val execution: ExecutionConf = ExecutionConf(
    ...
    interestingStudiesConf = readConfigFromFile[Execution.InterestingStudiesConf]("config/plot_generation/execution/interesting-studies.conf"),
    globalConf = readConfigFromFile[Execution.GlobalConf]("config/plot_generation/execution/global.conf"),
  )
  ...
  val storage: StorageConf = StorageConf(
    ...
    interestingStudiesConf = readConfigFromFile[Storage.InterestingStudiesConf]("config/plot_generation/storage/interesting-studies.conf"),
  ...
  val log: LogConf = LogConf(
    ...
    interestingStudiesConf = readConfigFromFile[Log.InterestingStudiesConf]("config/plot_generation/log/interesting-studies.conf"),
