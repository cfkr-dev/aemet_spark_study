...
set DOCKERFILE_FILE=.\Deployment\Docker\Dockerfile
...
echo HOST_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE = %HOST_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE%
echo CONTAINER_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE = %CONTAINER_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE%
...
docker run --rm -it ^
 ...
 --env STORAGE_RESOURCES_COUNTRIES_SHAPEFILE="%CONTAINER_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE%" ^
 -p %HOST_EXPOSED_PORT%:%CONTAINER_EXPOSED_PORT% ^
 -v "%HOST_STORAGE_BASE_DIR%":"%CONTAINER_STORAGE_BASE_DIR%" ^
 -v "%HOST_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE%":"%CONTAINER_STORAGE_RESOURCES_COUNTRIES_SHAPEFILE%" ^
 %IMAGE_NAME%
