...
:: ===== MAIN VARIABLES =====
set "CWD=%CD%"
set "AUTO_PLOT_WD=..\..\..\..\..\auto-plot\Deployment\docker\test-localstack"
set "DATA_EXTRACTION_WD=..\..\..\data-extraction\docker\test-localstack"
set "SPARK_APP_WD=..\..\..\spark-app\docker\test-localstack"
set "PLOT_GENERATION_WD=..\..\..\plot-generation\docker\test-localstack"
set "BUILD_SCRIPT=.\docker_build_and_run.bat"
set "COMPOSE_FILE=.\docker-compose.yaml"
set "ENV_FILE=.\.env"
set "AUTO_PLOT_IMAGE_NAME=auto-plot:v1.0"
set "DATA_EXTRACTION_IMAGE_NAME=data-extraction-localstack:v1.0"
set "SPARK_APP_IMAGE_NAME=spark-app-localstack:v1.0"
set "PLOT_GENERATION_IMAGE_NAME=plot-generation-localstack:v1.0"
