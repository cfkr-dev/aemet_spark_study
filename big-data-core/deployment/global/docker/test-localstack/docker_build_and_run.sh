...
DATA_EXTRACTION_IMAGE_NAME="data-extraction-localstack:v1.0"
SPARK_APP_IMAGE_NAME="spark-app-localstack:v1.0"
PLOT_GENERATION_IMAGE_NAME="plot-generation-localstack:v1.0"
